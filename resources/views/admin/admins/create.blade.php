    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-800">إنشاء مدير</h1>
            ...
            <form method="POST" action="{{ route('admin.admins.store') }}" class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">معلومة</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <p>سيتم إرسال بريد إلكتروني تلقائيًا إلى المدير الجديد مع بيانات تسجيل الدخول.</p>
                                <p class="mt-1">سيتم إنشاء المدير بحالة "مُتحقق" وسيتمكن من تسجيل الدخول مباشرة.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition-colors">
                        <i class="fas fa-user-plus mr-2"></i>إنشاء المدير
                    </button>
                </div>
            </form>
        </div>
