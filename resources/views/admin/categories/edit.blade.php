...
<div class="min-h-screen bg-gray-100 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Modifier la Catégorie</h1>
                <p class="text-gray-600 mt-1">Modifier les informations de : <strong>{{ $category->name }}</strong></p>
            </div>
            ...
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
                        ...
                        <div>
                            <span class="font-medium">Produits associés :</span>
