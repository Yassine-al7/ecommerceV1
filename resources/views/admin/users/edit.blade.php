    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Modifier le Vendeur</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="address"
                                  ...
                                  placeholder="Adresse complète du vendeur">{{ old('address', $user->address) }}</textarea>
                        @error('address')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-sm font-medium text-gray-800">Statut du Compte</h3>
                            <p class="text-xs text-gray-600 mt-1">Gérez l'activation du compte vendeur</p>
                        </div>
                        <div class="flex items-center space-x-3">
                            <span class="text-sm text-gray-600">Actuellement :</span>
                    ...
                    <div class="mt-3 text-xs text-gray-600">
                        <p><i class="fas fa-info-circle mr-1"></i>Pour modifier le statut, utilisez le bouton d'activation/désactivation dans la liste des vendeurs.</p>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex">
                        ...
                        <div class="text-sm text-blue-700">
                            ...
                            <ul class="mt-1 list-disc list-inside">
                                <li>Le rôle "Vendeur" ne peut pas être modifié</li>
                                <li>Si vous changez le mot de passe, le vendeur devra utiliser le nouveau</li>
